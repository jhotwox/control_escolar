...
class Users(Frame):
    def __init__(self, container, controller, type: user_class, *args, **kwargs):
        ...
        self.opm_type = OptMenu(fr_entry, values=(["administrador", "maestro", "alumno"]), variable=self.selected_type)
        ...
        self.table['columns'] = ("ID", "Nombre", "Correo", "Ap_paterno", "Ap_materno", "Contraseña", "Perfil")
    ...
    def save_user(self) -> None:
        ...
        try:
            type = find_id(self.type, self.opm_type.get())
            user = user_class(
                int(self.tx_id.get()),
                self.tx_name.get(),
    ...
    def get_user(self) -> None:
        ...
        self.opm_type.set(self.type[int(values[6])])
    ...
    def validate(self) -> None:
        ...
        if self.opm_type.get() not in ["administrador", "maestro", "alumno"]:
